...
//EVABlockScanner atom的区块链扫描器
type EVABlockScanner struct {
...
//NewEVABlockScanner 创建区块链扫描器
func NewEVABlockScanner(wm *WalletManager) *EVABlockScanner {
	bs := EVABlockScanner{
...
func (bs *EVABlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *EVABlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *EVABlockScanner) ScanBlock(height uint64) error {
...
func (bs *EVABlockScanner) scanBlock(height uint64) (*Block, error) {
...
func (bs *EVABlockScanner) ScanTxMemPool() {
...
func (bs *EVABlockScanner) RescanFailedRecord() {
...
func (bs *EVABlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *EVABlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
...
func (bs *EVABlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *EVABlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanTargetFunc, memPool bool) ExtractResult {
...
func (bs *EVABlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanTargetFuncV2) {
	var (
		success    = true
		multiindex = uint64(0)
	)
...
func (bs *EVABlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *EVABlockScanner) DeleteUnscanRecordNotFindTX() error {
...
func (bs *EVABlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *EVABlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
	...
	if blockHeight == 0 {
		blockHeight, err = bs.wm.GetBlockHeight()
		if err != nil {
			bs.wm.Log.Errorf("EVA GetBlockHeight failed,err = %v", err)
			return nil, err
		}
...
func (bs *EVABlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *EVABlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
func (bs *EVABlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
func (bs *EVABlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *EVABlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *EVABlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *EVABlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
	//
	//var (
...
//Run 运行
func (bs *EVABlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *EVABlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *EVABlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *EVABlockScanner) Restart() error {
...
func (bs *EVABlockScanner) setupSocketIO() error {
...
//@optional
func (bs *EVABlockScanner) SupportBlockchainDAI() bool {
	return true
}
